        ...
        const SOCIAL_ICON_SVGS = {
            ...
            email: `<svg aria-hidden="true" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.75A2.75 2.75 0 0 1 4.75 2h14.5A2.75 2.75 0 0 1 22 4.75v14.5A2.75 2.75 0 0 1 19.25 22H4.75A2.75 2.75 0 0 1 2 19.25zm2.75-1.25a1.25 1.25 0 0 0-1.25 1.25v.638l8.263 5.216a.75.75 0 0 0 .774 0L20.5 5.388V4.75a1.25 1.25 0 0 0-1.25-1.25zm15.75 3.562-6.93 4.376 6.93 4.497zm-.748 11.803L12 13.461l-7.752 5.404a1.25 1.25 0 0 0 .498.085h14.504a1.25 1.25 0 0 0 .502-.09zM3.5 17.938l6.927-4.46L3.5 9.115z"/></svg>`
        };
        ...
        <div class="category${category.id === firstCategoryWithProducts ? ' active' : ''}" id="${category.id}">
            ...
            const emailAddressRaw = trimmedConfig.email;
            ...
            const emailLinkHref = emailAddressRaw ? escapeHtml(`mailto:${emailAddressRaw}`) : '#';
            const emailLinkStyle = emailAddressRaw ? '' : 'display: none;';
            ...
            const socialLinksMarkup = `
                <div class="social-links" id="footerSocialLinks" aria-label="Redes sociales" style="${socialLinksContainerStyle}">
                    ...
                    <a id="footerSocialEmail" class="social-link social-link--email" href="${emailLinkHref}" style="${emailLinkStyle}">
                        ${getSocialIconSvg('email')}
    ...
    <\/script>
        ...
        * {
        ...
        function applyConfig() {
            ...
            const footerEmail = document.getElementById('footerSocialEmail');
            ...
            if (footerEmail) {
                if (emailValue) {
                    ...
                    footerEmail.style.display = 'inline-flex';
                    hasFooterSocial = true;
                } else {
