        ...
        function buildThemeTokens(appearance) {
            ...
            const headerShadow = hexToRgba(normalized.header, 0.25);
            const headerShadowHover = hexToRgba(normalized.header, 0.35);
...
${formatCssBlock(footerBackground)}
        ...
        .selected-products-toggle:focus {
            transform: translateY(-3px);
            box-shadow: 0 24px 45px ${theme.headerShadowHover};
        }
